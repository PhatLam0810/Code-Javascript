        ...
        songs : [
            {
                ...
                singer : 'Lâm Phúc',
                path : '/Music-Play/assets/music/ThoiGianSeChuaLanhTatCa-LamPhuc-14233024.mp3',
                image : '/Music-Play/assets/img/thoigiansechualanhtatca.jpg'
            },
            {
                name : 'Giá như em nhìn lại',
                singer : 'JSOL',
                path : '/Music-Play/assets/music/GiaNhuEmNhinLai-JSOL-13090066.mp3',
                image : '/Music-Play/assets/img/gianhuemnhinlai.jpg'
            },
            {
                name : 'Đau nhất là lặng im',
                singer : 'ERIK',
                path : '/Music-Play/assets/music/DauNhatLaLangIm-ERIK-7130326.mp3',
                image : '/Music-Play/assets/img/daunhatlalangim.jfif'
            },
            {
                name : 'Tình yêu đến sau',
                singer : 'MyraTran',
                path : '/Music-Play/assets/music/TinhYeuDenSau-MyraTran-8294285.mp3',
                image : '/Music-Play/assets/img/tinhyeudensau.webp'
            },
            {
                name : 'Âm Thầm Bên Em',
                singer : 'Sơn Tùng MTP',
                path : '/Music-Play/assets/music/AmThamBenEm-SonTungMTP-4066476.mp3',
                image : '/Music-Play/assets/img/amthambenem.jpg'
            },
            {
                name : 'Âm Thầm Bên Em',
                singer : 'Sơn Tùng MTP',
